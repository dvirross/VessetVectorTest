...
\begin{titlepage}
  ...
  \vspace{0.5cm}
  \begin{flushleft}
  [Author and affiliation details removed for peer review].
  ...
  \medskip
  Correspondence:
  [email removed for peer review] or [email removed for peer review]
  \end{flushleft}
\end{titlepage}
...
\newpage
\begin{center}
  {\large\bfseries [Author details removed for peer review]\par}
\end{center}
