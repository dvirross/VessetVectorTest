...
detects significant multivariate departure from the null ($D_M = 4.52$, $p < .001$),
...
vesset patterns occur at rates distinguishable from chance in real data.
...
patterns occur at rates distinguishable from chance in empirical menstrual cycle data. The five patterns
