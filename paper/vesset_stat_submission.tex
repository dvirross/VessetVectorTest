...
progression). These form a polynomial hierarchy whose structure generates algebraic structural
relationships --- one a strict logical containment, one an algebraic approximation ---
examined by exploratory pairwise permutation tests ($p_{\text{perm}} < .014$).
...
reflecting concentration of patterns among women with lower observed cycle-length variability.
...
relationships --- one a strict logical containment (Week-Dilug $\subseteq$ Haflaga-30),
