...
\begin{titlepage}
  ...
  \vspace{0.5cm}
  \begin{flushleft}
  [Author details removed for peer review], Shenkar College of Engineering,
  ...
  Analysis code is publicly available at [URL removed for peer review].

  \medskip
  Correspondence:
  [Contact details removed for peer review]
  \end{flushleft}
\end{titlepage}
