...
rule as a sixth component of the joint statistic, on the same paired replicates, leaves
the observed $\DM$ unchanged ($5.07$, $4.87$ and $2.98$ under $\HG$, $\HI$ and $\HW$)
and moves the joint $p$-values from $< .001$, $< .001$ and $.115$ to $< .001$, $< .001$
and $.139$, because every null replicate that contains an event lies beyond the observed
vector; in the Holm family the rule would contribute a $p$-value of 1. The conclusions
are therefore unaffected by its exclusion. The five-pattern family was nevertheless fixed after
