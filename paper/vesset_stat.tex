...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{fig3_dm_nulldist}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{fig_joint_3panels}
  \caption{Geometric illustration of the focused 3-pattern joint test under the
    ...
    Marker size encodes Dilug count; marker colour encodes Week count.
    ...
    is non-significant ($D_M = 2.68$, $p = .066$), consistent with the primary result.}
...
The joint test (Eq.~\ref{eq:mahalanobis}) represents a methodological contribution
...
highly significant results, confirming that the primary finding is robust to the choice
of pattern subset. Haflaga receives appropriately up-weighted contribution via the
