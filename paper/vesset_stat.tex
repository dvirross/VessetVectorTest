...
observed zero is the modal null outcome (two-sided $p = 1$ under each null) and the
rule's exclusion from the five-pattern family, the joint statistic and the Holm family
cannot affect the conclusions. The five-pattern family was nevertheless fixed after
