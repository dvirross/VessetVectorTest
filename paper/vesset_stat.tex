...
The marginal tests are one-sided (upper-tail), testing the directional hypothesis that
each pattern is \emph{overrepresented} relative to the null. The joint Mahalanobis
distance is inherently two-sided --- it measures displacement from the null centre in
any direction --- and serves as an omnibus test of whether the observed count vector
is jointly unusual, regardless of direction.
