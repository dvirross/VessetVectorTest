...
statistically \citep{ross2021statistical}; none tested pattern frequencies against a
randomisation null.
...
its power against autoregressive alternatives is modest at realistic coefficients
(Section~\ref{sec:simresults}), so the non-rejection is informative about
exact-repetition mechanisms and much less so about smooth serial dependence. The
...
holds its nominal size, that the within-woman tests have substantial power against
exact-repetition alternatives and modest power against smooth autoregressive ones, and
that the conclusions are insensitive to unequal follow-up. The results are consistent with
