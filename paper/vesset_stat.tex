...
cycles analysed with identical code (global $\DM = 9.99$; within-woman $\DM = 1.20$,
...
(5--15 per woman). Code, seed, $B$ and simulation sizes were identical to the main
analysis; full results are in the Supporting Information (Section~S4) and the
