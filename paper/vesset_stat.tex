...
\noindent
Counts of deterministically defined patterns in clustered longitudinal sequences can
depend strongly on the exchangeability null used to define ``chance'': the same excess
