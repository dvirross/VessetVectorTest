...
\caption{Pairwise Spearman rate-based correlation tests between vesset types ($N = 118$ women).
  ...
  $^*$: analytically predicted positive pair (Section~\ref{sec:mathdep}).
...
\midrule
\textbf{Haflaga $\times$ Dilug-in-Dilug}$^*$ & \textbf{0.27} & \textbf{.003} & \textbf{.030} & $+$ \\
Haflaga $\times$ Week-Dilug$^*$   & 0.23 & .010 & .090 & $+$ \\
...
\begin{figure}[H]
  ...
  \caption{Pairwise Spearman correlation structure between vesset pattern types.
    ...
    (Haflaga $\times$ Dilug-in-Dilug and Haflaga $\times$ Week-Dilug, marked $^*$)
