...
| `scripts/` | `prepare_utah.py`, `run_external.py`, `analysis_engine.py`, `external_figures.py`, `build_replication_notebook.py` |
| `notebooks/replication.ipynb` | executed notebook re-deriving every table and figure from the cached replicates (generated by the builder; edit the builder, not the notebook) |
