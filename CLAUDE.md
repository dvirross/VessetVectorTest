...
## 7. Current numbers (seed 17, B = 50,000, 1,554 cycles) — from `results/summary.json`
...
| Week-Dilug | 18 | 20.91 | 3.22 | −0.90 | .460 | 1 |
| Dilug-in-Dilug | 27 | 39.12 | 5.84 | −2.07 | .038 | .192 |
| Joint 5-pattern | D_M = 2.93, p = .126 (split-batch 2.95, .119); LOO range .055–.224 |

**H_G (global permutation):** Haflaga z = 4.50, two-sided p = .0002 (4 of 50,000 ≥ 26), Holm .001; Dilug z = 1.84, p = .085 (Holm .34); Week p = .265; Week-Dilug p = .688; DiD p = 1.0. Joint D_M = 5.08, p < .001 (6 exceed). H_iid: joint D_M = 4.87 (17 exceed); Week p = .373.
**3-pattern exploratory:** D_M = 4.50 / 4.39 / 2.68 (p = .067 under H_W).
...
- [x] Zero-count rule evaluated (2026-09-17): only **one** further rule is interval-computable — *Haflaga Chozer Chalila* (Dilug Chozer Chalila depends on calendar dates → 17 rules = 11 date-dependent + 6 interval-computable). Observed 0; null mean 0.0003 (H_G), 0.0004 (H_iid), 0.028 (H_W); P(≥1) = 0.03%, 0.04%, 2.8%; two-sided p = 1. 6-component joint test on paired replicates: D_M unchanged (5.08/4.87/2.94), p .0005/.0007/.150 (vs .0001/.0004/.126). Reported in §3.1 and SI Section S3 (Tables S2–S3); conclusions unaffected
